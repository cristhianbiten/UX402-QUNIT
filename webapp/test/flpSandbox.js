		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Unit Tests",
									"targetURL": "#student10comsaptrainingux402qunitux402qunit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student10comsaptrainingux402qunitux402qunit-display": {
								"semanticObject": "student10comsaptrainingux402qunitux402qunit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student10.com.sap.training.ux402.qunit.ux402qunit",
									"url": sap.ui.require.toUrl("student10/com/sap/training/ux402/qunit/ux402qunit")
								}
							}
						}
					}
